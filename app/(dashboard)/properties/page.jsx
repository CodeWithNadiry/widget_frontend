    ...
    <div className="max-w-3xl flex flex-col gap-6">
      ...
      {isLoading ? (
        ...
        <div className="bg-white border border-slate-200 rounded-xl flex flex-col items-center justify-center py-16 text-center">
          ...
          <p className="text-[15px] font-medium text-slate-900 mb-1">No properties yet</p>
          <p className="text-[14px] text-slate-500 mb-5">Add your first hotel property to get started.</p>
          <Link
            href="/properties/new"
        ...
        <div className="flex flex-col gap-5 w-80">
          <div>
            ...
            <p className="text-sm text-slate-500 mt-1">
              This will permanently remove the property. This cannot be undone.
            </p>
          </div>
