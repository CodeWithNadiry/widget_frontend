      ...
      >
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-2.5">
            ...
            <span className="text-xl font-bold text-white tracking-tight">HotelBot</span>
          </div>
        </div>
        ...
        <div className="relative z-10 max-w-sm">
          ...
          <p className="text-slate-400 text-[15px] leading-relaxed mb-10">
            Manage properties, upload knowledge documents, and deploy trained chatbots — all from one place.
          </p>

          <div className="space-y-4">
            {[
              { icon: "🏨", text: "Manage multiple properties from one dashboard" },
              { icon: "📄", text: "Upload documents to build your knowledge base" },
              { icon: "⚡", text: "Deploy chatbots trained on your hotel's data" },
            ].map((item) => (
              <div key={item.text} className="flex items-start gap-3">
                ...
                <p className="text-slate-300 text-[15px] leading-relaxed pt-1.5">{item.text}</p>
              </div>
            ))}
          </div>
        </div>

        <p className="relative z-10 text-slate-600 text-xs">© 2026 HotelBot. All rights reserved.</p>
      </div>
      ...
      <div className="flex-1 flex flex-col justify-center items-center px-5 py-10 sm:px-8">
        ...
        <div className="lg:hidden mb-8 text-center">
          <div className="flex items-center justify-center gap-2 mb-2">
            ...
            <span className="text-2xl font-bold text-slate-900">HotelBot</span>
          </div>
          <p className="text-slate-500 text-[15px]">AI-powered hotel chatbot platform</p>
        </div>
